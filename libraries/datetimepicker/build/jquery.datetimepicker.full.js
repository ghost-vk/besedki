	...
	$.fn.datetimepicker = function (opt, opt2) {
		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
				...
				loader = $('<div class="xdsoft_loader"><div class="lds-ripple"><div></div><div></div></div></div>'),
			...
			datetimepicker.setOptions = function (_options) {
				...
				if (_options.productID) {
					options.productID = $.extend(true, [], _options.productID);
				}
			...
			datetimepicker
				.on('xchange.xdsoft', function (event) {
					...
					xchangeTimer = setTimeout(function () {
						...
						if (options.allowTimes && options.allowTimes === "") { // If set allowed time, but haven't available time
							let noTimesBlock = `<div>Резерв</div>`;
							timebox.html(noTimesBlock);
						} else {
							timebox.html(time);
						}
