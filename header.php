...
<head>
	...
	<body class="lightBg">
        <div id="main">
                ...
                <?php if ( !is_mobile() ) : ?>
                    <div class="preheader">
                        ...
                        <div class="preheader__contacts">
                            <?php if ( $address ) : ?>
                                <a href="<?= $address['url']; ?>" target="<?= $target; ?>"><?= $address['title']; ?></a>
                            <?php endif; ?>
                            <?php if ( $phone ) : ?>
                                <a class="underline" href="<?= $phone['url']; ?>"><?= $phone['title']; ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="header">
                        <div class="c-container">
                            <div class="header__icon">
                                <a href="<?= home_url(); ?>">
                                    <img src="<?= get_stylesheet_directory_uri(); ?>/img/icon/logo.svg" alt="Логотип">
                                </a>
                            </div>
                            <div class="header__reservation">
                                <a class="whiteBtn1" href="<?= home_url('/reservation'); ?>">Забронировать</a>
                            </div>
                ...
                <?php else : ?>
                    <div class="headerMobile">
                        <div class="headerMobile__icon">
                            <a href="<?= home_url(); ?>">
                                <img src="<?= get_stylesheet_directory_uri(); ?>/img/icon/logo_mobile.svg" alt="Логотип">
                            </a>
                        </div>
                        <div class="headerMobile__row">
                            ...
                            <div class="headerMobile__address">
                                <a href="<?= $address['url']; ?>" target="<?= $target; ?>">
            ...
            <?php do_action('store_user_key_in_cookie'); ?>