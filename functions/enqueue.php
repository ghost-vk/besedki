...
function add_scripts () {
	// General scripts
	wp_enqueue_script('utils-besedka', get_stylesheet_directory_uri() . '/js/lib/utils.js', array(), null, true);
	wp_enqueue_script('store', get_stylesheet_directory_uri() . '/js/lib/store.js', array('utils-besedka'), null, true);
	...
	if ( is_archive() ) {
		...
		wp_enqueue_script('popup-lib', get_template_directory_uri() . '/js/lib/popup/Popup.js', array( // Main handler
			'jquery',
			'store',
			'slider-handler',
			'select-handler',
		...
		wp_enqueue_script('slider-handler', get_template_directory_uri() . '/js/lib/popup/Slider.js', array('jquery', 'slick'), null, true);
		wp_enqueue_script('select-handler', get_template_directory_uri() . '/js/lib/popup/SelectDuration.js', array('jquery', 'custom-select'), null, true);
		wp_enqueue_script('datetime-handler', get_template_directory_uri() . '/js/lib/popup/DatetimeHandler.js', array('jquery', 'datetimepicker'), null, true);
		wp_enqueue_script('booking', get_template_directory_uri() . '/js/lib/popup/Booking.js', array(), null, true);
		
		wp_enqueue_script('map-handler', get_template_directory_uri() . '/js/lib/map/MapHandler.js', array( // Main handler
			'jquery',
		), null, true);
		
		wp_enqueue_script('map', get_template_directory_uri() . '/js/reservation/map.js', array('jquery', 'map-handler'), null, true);
